...
<style>
  ...
  .btn-primary { padding:14px 30px; background:#5b21b6; color:white; border-radius:8px; cursor:pointer; font-weight:bold; }
  .btn-primary:hover { background:#4c1d95; }
  .btn-secondary { padding:14px 30px; border:1px solid #ddd; color:#5b21b6; border-radius:8px; cursor:pointer; }
  ...
  .cta-big-btn { padding:16px 40px; background:white; color:#5b21b6; border-radius:12px; font-weight:bold; }
